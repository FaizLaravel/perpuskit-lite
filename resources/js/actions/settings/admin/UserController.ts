 ...
 * @see app/Http/Controllers/Admin/UserController.php:87
 ...
 * @see app/Http/Controllers/Admin/UserController.php:125
 * @route '/users/{user}'
 */
...
const UserController = { resetPassword, index, create, store, show, edit, update, destroy }
