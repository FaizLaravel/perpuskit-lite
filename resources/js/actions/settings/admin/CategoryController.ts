 ...
 * @see app/Http/Controllers/Admin/CategoryController.php:41
 ...
 * @see app/Http/Controllers/Admin/CategoryController.php:69
 ...
 * @see app/Http/Controllers/Admin/CategoryController.php:92
 * @route '/categories/{category}'
 */
